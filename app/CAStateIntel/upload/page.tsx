                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    {(uf.status === 'queued' || uf.status === 'error') && (
                      <div className="mt-1.5">
                        <button onClick={() => update(uf.id, { showOverride: !uf.showOverride })}
                        ...
                        {uf.showOverride && (
                          <div className="flex gap-2 mt-2 flex-wrap">
                            <input type="text" placeholder="Project # (e.g. 4265-081)"
                              value={uf.manualProject ?? ''}
                              onChange={e => update(uf.id, { manualProject: e.target.value })}
                              className="w-36 px-2 py-1 border border-gray-200 rounded text-xs focus:outline-none focus:ring-1 focus:ring-gray-400" />
                            <select value={uf.manualStage ?? 0}
                              onChange={e => update(uf.id, { manualStage: parseInt(e.target.value) || undefined })}
                              className="px-2 py-1 border border-gray-200 rounded text-xs bg-white focus:outline-none focus:ring-1 focus:ring-gray-400">
